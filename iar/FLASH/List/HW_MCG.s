...
//    Endian       =  little
//    Source file  =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\lib\LPLD\HW\HW_MCG.c
//    Command line =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\lib\LPLD\HW\HW_MCG.c
...
//    List file    =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\iar\FLASH\List\HW_MCG.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  303   MCG->C1 = MCG_C1_CLKS(2) | MCG_C1_FRDIV(3);  
        MOVS     R0,#+152
        LDR.W    R12,??LPLD_PLL_Setup_19+0x4  ;; 0x40064000
        STRB     R0,[R12, #+0]
//  304   while (MCG->S & MCG_S_IREFST_MASK){}; // 等待参考时钟清零
??LPLD_PLL_Setup_20:
        LDR.N    R0,??LPLD_PLL_Setup_19+0x8  ;; 0x40064006
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+27
...
//  310   MCG->C5 = MCG_C5_PRDIV0(prdiv); // 设置 PLL 匹配晶振的参考分频数 
        ANDS     R0,R7,#0x1F
        LDR.N    R7,??LPLD_PLL_Setup_19+0xC  ;; 0x40064004
        STRB     R0,[R7, #+0]
//  311   // 确保MCG_C6处于复位状态,禁止LOLIE、PLL、和时钟控制器,清PLL VCO分频器
//  312   MCG->C6 = 0x0;
        MOVS     R0,#+0
        LDR.N    R7,??LPLD_PLL_Setup_19+0x10  ;; 0x40064005
        STRB     R0,[R7, #+0]
//  313   //设置系统时钟分频系数
...
//  316   MCG->C6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(vdiv); 
        ANDS     R0,R5,#0x1F
        ORRS     R0,R0,#0x40
        LDR.N    R1,??LPLD_PLL_Setup_19+0x10  ;; 0x40064005
        STRB     R0,[R1, #+0]
...
//  321   MCG->C1 &= ~MCG_C1_CLKS_MASK;
        LDR.N    R0,??LPLD_PLL_Setup_19+0x4  ;; 0x40064000
        LDRB     R0,[R0, #+0]
        ANDS     R0,R0,#0x3F
        LDR.N    R1,??LPLD_PLL_Setup_19+0x4  ;; 0x40064000
        STRB     R0,[R1, #+0]
