...
//    List file    =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\iar\FLASH\List\HW_USB.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   58   USB0->USBTRC0 = 0x40;                   //按照文档所述，此位必须设置为1
        MOVS     R0,#+64
        LDR.N    R1,??DataTable3_2  ;; 0x4007210c
        STRB     R0,[R1, #+0]
//   59   SIM->SOPT1 |= SIM_SOPT1_USBREGEN_MASK;  //配置USB设备稳压源
        LDR.N    R0,??DataTable3_3  ;; 0x40047000
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x80000000
        LDR.N    R1,??DataTable3_3  ;; 0x40047000
        STR      R0,[R1, #+0]
//   60   
//   61   /* NVIC模块配置 */
