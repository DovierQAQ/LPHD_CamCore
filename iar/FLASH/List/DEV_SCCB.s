...
//    Endian       =  little
//    Source file  =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\lib\LPLD\DEV\DEV_SCCB.c
//    Command line =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\lib\LPLD\DEV\DEV_SCCB.c
...
//    List file    =  
//        C:\Users\ShowD\Desktop\LPHD\LPHD_camCore\LPHD_camCore\iar\FLASH\List\DEV_SCCB.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   41   pta.GPIO_PTx = PTB;
        ...
        STR      R0,[SP, #+4]
//   42   pta.GPIO_Pins = GPIO_Pin17 | GPIO_Pin21;
        MOVS     R0,#+2228224
        STR      R0,[SP, #+8]
//   43   /********用户可修改值 结束***********/
...
//  155   SCCB_SDA_O=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_1  ;; 0x43fe0854
        STR      R0,[R1, #+0]
//  156   SCCB_SCL=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_2  ;; 0x43fe0844
        STR      R0,[R1, #+0]
//  157   SCCB_DELAY();
        MOVW     R0,#+5000
        BL       LPLD_SCCB_Delay
...
//  159   SCCB_SDA_IN();
        MOVS     R0,#+0
        LDR.N    R1,??DataTable7_3  ;; 0x43fe0ad4
        STR      R0,[R1, #+0]
//  160   if(!SCCB_SDA_I)
        LDR.N    R0,??DataTable7_4  ;; 0x43fe0a54
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
